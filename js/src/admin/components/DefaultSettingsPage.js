...
export default class DefaultSettingsPage extends ExtensionPage {
  oninit(vnode) {
    ...
    this.welcomeSettings = JSON.parse(
      app.data.settings["block-cat.welcome_settings"] || null
    );
    ...
    // get settings vasia
    this.vasia_settings = JSON.parse(
      app.data.settings["block-cat.vasia_settings"]
    );
      ...
      m(".ExtensionPage-settings", [
        m(".container", [
          ...
          m(
            ...
            [
              m(".SettingsGroup", [
                // contains all group settings
                m(".Welcome", [
                  // Start Welcome Settings
                  m(
                    "label.hello",
                    app.translator.trans(
                      "block-cat-default.admin.welcome_settings.title"
                    )
                  ),
                  Object.keys(this.welcomeSettings).map((key) => {
                    return m(".Form-group." + key, [
                      m(
                        "label",
                        app.translator.trans(
                          `block-cat-default.admin.welcome_settings.${key}`
                        )
                      ),
                      m(
                        ".helpText",
                        app.translator.trans(
                          `block-cat-default.admin.welcome_settings.${key}_text`
                        )
                      ),
                      m(
                        key === "sliderItems"
                          ...
                          : "input.FormControl",
                        {
                          ...
                          value:
                            key === "sliderItems"
                              ? this.welcomeSettings[key].join("\n")
                              : this.welcomeSettings[key],
                          placeholder: app.translator.trans(
                            "block-cat-default.admin.welcome_settings.placeholder"
                          ),
                          oninput: (e) => {
                            key === "sliderItems"
                              ? (this.welcomeSettings[key] =
                ...
                m(".Settings", [
                  ...
                  m(
                    "label",
                    app.translator.trans(
                      "block-cat-default.admin.settings.title"
                    )
                  ),
                  ...
                  Object.keys(this.vasia_settings).map((key) => {
                    if (
                      ...
                      key === "view_hero" ||
                      key === "sidenav_fixed" ||
                      key === "remove_additional_space" ||
                      key === "add_input_hover_style" ||
                      key === "display_pdf_files" ||
                      key === "add_borders" ||
                      key === "author_bottom"
                    ) {
                      return [
                        m(".Form-group", [
                          // controlsButton and scrubberDiv
                          Switch.component(
                            {
                            ...
                            m(
                              "li",
                              app.translator.trans(
                                `block-cat-default.admin.vasia_settings.${key}`
                              )
                            )
                          ),
                        ]),
                      ...
                      key === "title_font_size" ||
                      key === "item_excerpt_font_size" ||
                      key === "item_excerpt_color"
                    ) {
                      return [
                        m(
                          ".Form-group .inline",
                          // if icon exists this will be displayed realtime on page
                          this.vasia_settings[key] !== ""
                            ? icon(this.vasia_settings[key])
                            : "",
                          this.vasia_settings[key] !== ""
                            ? m(
                                "span",
                ...
                m(".Settings2", [
                  ...
                  m(
                    "label",
                    app.translator.trans(
                      "block-cat-default.admin.settings2.title"
                    )
                  ),
                  ...
                  Object.keys(this.vasia_settings).map((key) => {
                    if (
                      key === "button_3d_new" ||
                      key === "buttons_votes_comments_views" ||
                      key === "view_tags" ||
                      key === "button_etichete" ||
                      key === "button_adauga_right" ||
                      key === "show_item_sort" ||
                      key === "rankings_button_header"
                    ) {
                      return [
                        m(".Form-group", [
                          // controlsButton and scrubberDiv
                      ...
                      (key === "tags_bottom" &&
                        this.vasia_settings["view_tags"]) ||
                      (key === "modify_item_sort" &&
                        this.vasia_settings["show_item_sort"]) ||
                      (key === "button_etichete_in_header" &&
                        this.vasia_settings["button_etichete"])
                    ) {
                      return [
                        m(".Form-group .Form-group-children", [
                          // controlsButton and scrubberDiv
                          Switch.component(
                            {
                              state: this.vasia_settings[key] || false,
  ...
  onsubmit(e) {
    ...
    try {
      ...
      this.welcomeSettings = JSON.parse(
        app.data.settings["block-cat.welcome_settings"]
      );
      this.vasia_settings = JSON.parse(
        app.data.settings["block-cat.vasia_settings"]
      );
