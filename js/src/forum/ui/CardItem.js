                                    ...
                                    <Link className="author-link" href={user ? app.route.user(user) : '#'} style="flex-direction: column;">
                                        ...
                                        <div style="display: flex;">
                                            ...
                                            <div>
                                                ...
                                                <p>{user.data.attributes.points ? <span><i class="icon fas fa-trophy Button-icon" style="font-size: 10px; margin-right: 2px;"></i>{user.data.attributes.points}</span> : ""} {user.data.attributes.discussionCount ? <span><i class="icon fas fa-comment Button-icon" style="font-size: 10px; margin-right: 2px;"></i>{user.data.attributes.discussionCount}</span> : ""}</p>
                                            </div>
                                        </div>
                                    </Link>
                                </div>
